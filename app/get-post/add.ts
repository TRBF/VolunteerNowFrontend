...
export async function getUsers() {
    const url = 'http://188.214.88.101:3000/api/login?username&password';
...
export async function createUser(username, password, gender, first_name, last_name, email) {
    const url = 'http://188.214.88.101:3000/api/register';
    const response = await fetch(url, {
        method: 'POST',
        headers: {
...
export async function eventGet(number) {
    const url = 'http://188.214.88.101:3000/api/get_events?page';
    const response = await fetch(url);
...
export async function eventAdd(name, description, link_to_pfp, link_to_cover_image, edition, location, time) {
    const url = 'http://188.214.88.101:3000/api/add_event';
    const response = await fetch(url, {
        method: 'POST',
        headers: {
        'Content-Type': 'application/json',
...
export async function addExperiences(userid){
    const url = `http://188.214.88.101:3000/api/get_experiences/${userid}`;
    const response = await fetch(url);
